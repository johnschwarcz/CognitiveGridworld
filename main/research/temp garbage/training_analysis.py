...
training = globals().get("training", False)
if not training:
    core_fig, core_ax, vbundle, single_fig, single_ax = make_core_figure(
        ...
        D=4,
        episode_lim=None,                
        single_panel="LOGITPERF",            
        single_panel_svg_path="LOGITPERF.svg"
    )
    plt.show()
...
#  ("ACC", "DIFF", "CORR", "GRADD", "ENTD"), ("ENTIO", "PR", "PRIO", "GRADO", "GRADI"), ("VARBAR", "DIST0", "LOGITPERF", "LOGITSCALE", "NONE")
